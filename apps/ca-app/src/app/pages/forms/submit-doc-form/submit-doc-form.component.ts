...
@Component({
  selector: 'app-submit-doc-form',
  templateUrl: './submit-doc-form.component.html',
  styleUrls: ['./submit-doc-form.component.css'],
  providers: [TimePipe, DatePipe]
})
export class SubmitDocFormComponent implements OnInit, OnDestroy {
