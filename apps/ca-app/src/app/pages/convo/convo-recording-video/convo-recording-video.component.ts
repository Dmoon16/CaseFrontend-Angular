...
@Component({
  selector: 'app-convo-recording-video',
  templateUrl: './convo-recording-video.component.html',
  styleUrls: ['./convo-recording-video.component.css']
})
export class ConvoRecordingVideoComponent implements OnInit {
  public caseId: any = '';
  ...
  loadRecordVideo() {
    this.convoService.getConvosRecordings(this.caseId).subscribe(
      (res: any) => {
        ...
        this.recordList?.forEach((fl: any, i: number) => {
