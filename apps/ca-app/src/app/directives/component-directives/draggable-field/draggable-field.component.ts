...
const PAGE_ALL_SIDES_MARGIN: number = 32;

@Component({
  selector: 'app-draggable-field',
  templateUrl: './draggable-field.component.html',
  styleUrls: ['./draggable-field.component.css'],
  host: {
...
export class DraggableFieldComponent implements OnChanges, OnInit, DoCheck {
  ...
  onResizeEnd($event: any, wrapper: HTMLDivElement): void {
