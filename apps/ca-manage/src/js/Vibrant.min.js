                ...
                if (v[s] > A / 2) {
                  for (
                    n = o.copy(),
                      ...
                      r = s - o[h],
                      i = o[u] - s,
                      a = i >= r ? Math.min(o[u] - 1, ~~(s + i / 2)) : Math.max(o[h], ~~(s - 1 - r / 2));
                    !v[a];
              ...
              count: function (r) {
                ...
                if (!o._count_set || r) {
                  var n,
                    ...
                    u = 0;
                  for (n = o.r1; n <= o.r2; n++)
                    for (e = o.g1; e <= o.g2; e++) for (a = o.b1; a <= o.b2; a++) (h = t(n, e, a)), (u += i[h] || 0);
            ...
            (function () {
              ...
              return (
                ...
                (t.prototype.getHex = function () {
                  return (
                    '#' + ((1 << 24) + (this.rgb[0] << 16) + (this.rgb[1] << 8) + this.rgb[2]).toString(16).slice(1, 7)
                  );
                }),
                ...
                (t.prototype._ensureTextColors = function () {
                  return this.yiq
                    ? void 0
                    : (this.yiq = (299 * this.rgb[0] + 587 * this.rgb[1] + 114 * this.rgb[2]) / 1e3);
                }),
                t
              );
            })()),
              ...
              (function () {
                  ...
                  try {
                    for (l = f.getImageData(), T = l.data, v = f.getPixelCount(), h = [], p = 0; v > p; )
                      (A = 4 * p),
                        ...
                        (u = T[A + 2]),
                        (a = T[A + 3]),
                        a >= 125 && ((g > 250 && c > 250 && u > 250) || h.push([g, c, u])),
                        (p += e);
                    (s = this.quantize(h, i)),
                ...
                return (
                  ...
                  (i.prototype.generateEmptySwatches = function () {
                    ...
                    return (
                      void 0 === this.VibrantSwatch &&
                        ...
                        (this.VibrantSwatch = new o(i.hslToRgb(t[0], t[1], t[2]), 0))),
                      void 0 === this.DarkVibrantSwatch && void 0 !== this.VibrantSwatch
                        ? ((t = this.VibrantSwatch.getHsl()),
                          (t[2] = this.TARGET_DARK_LUMA),
                          (this.DarkVibrantSwatch = new o(i.hslToRgb(t[0], t[1], t[2]), 0)))
                        : void 0
                    );
                  }),
                  (i.prototype.findMaxPopulation = function () {
                    var t, r, o, i, n;
                    for (o = 0, i = this._swatches, t = 0, r = i.length; r > t; t++)
                      (n = i[t]), (o = Math.max(o, n.getPopulation()));
                    return o;
                  }),
                  (i.prototype.findColorVariation = function (t, r, o, i, n, e) {
                    var a, h, u, s, c, p, f, l, A;
                    for (s = void 0, c = 0, p = this._swatches, a = 0, h = p.length; h > a; a++)
                      (l = p[a]),
                        (f = l.getHsl()[1]),
                        (u = l.getHsl()[2]),
                        f >= n &&
                          ...
                          ((A = this.createComparisonValue(f, i, u, t, l.getPopulation(), this.HighestPopulation)),
                  ...
                  (i.prototype.weightedMean = function () {
                    var t, r, o, i, n, a;
                    for (n = 1 <= arguments.length ? e.call(arguments, 0) : [], r = 0, o = 0, t = 0; t < n.length; )
                  ...
                  (i.rgbToHsl = function (t, r, o) {
                    ...
                    if (
                      ...
                      switch (((i = a - h), (u = e > 0.5 ? i / (2 - a - h) : i / (a + h)), a)) {
                        case t:
                          n = (r - o) / i + (o > r ? 6 : 0);
                          break;
                        case r:
                    ...
                    return (
                      ...
                      (e = function (t, r, o) {
                        return (
                          0 > o && (o += 1),
                          o > 1 && (o -= 1),
                          1 / 6 > o ? t + 6 * (r - t) * o : 0.5 > o ? r : 2 / 3 > o ? t + (r - t) * (2 / 3 - o) * 6 : t
                        );
                      }),
                      0 === r
                        ? (u = n = i = o)
