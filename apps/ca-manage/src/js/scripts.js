  ...
  var Default = {
    utils: {
      ...
      forms: function () {
        ...
        //   for (let i = 0; i < $('.copy-svg-icon').length; i++) {
        //     if ($('.copy-svg-icon')[i] != $(e.target)) $('.copy-svg-icon')[i].src = 'images/copy-icon-inactive.svg';
        //   }
        ...
        $(document).on('click', '.color-picker', function (e) {
          var target = e.target.closest('.color-picker');
      ...
      bx: function () {
        ...
        $('.slider-a .bx-viewport')
          ...
          .children('a')
          .addClass('active');
        $('.slider-a .custom-pager').each(function () {
          $(this).clone().attr('class', 'mobile-pager').insertAfter($(this));
        });

        $('.slider-a .custom-pager')
        ...
        $('.slider-a .custom-pager.slider > .inner').each(function () {
          $(this).bxSlider({
            pager: false,
            controls: true,
            useCSS: false,
        ...
        $('.slider-a .mobile-pager a[data-slide-index]').on('click', function () {
          $(this).parents('.mobile-pager').find('.active').removeClass('active');
          $(this)
            .addClass('active')
            .parents('.slider-a')
            .find('.custom-pager')
            .find('a[data-slide-index="' + $(this).attr('data-slide-index') + '"]')
            .click();
        });
        $('.slider-a').each(function () {
          tn = 1;
          $(this).each(function () {
            $(this).attr('data-gallery-index', 'gallery-' + tn);
            tn++;
          });
        });
        $('.slider-a').each(function () {
          $(this)
            .children('.bx-wrapper')
            .children('.bx-viewport')
            .find('a')
            .attr('rel', $(this).attr('data-gallery-index'));
        });
      ...
      copying: function () {
        $('body').on('click', 'a[data-copy]', function () {
          $('html')
            .find('*[data-copied="' + $(this).attr('data-copy') + '"]:first')
            .addClass('copying')
            .each(function () {
              $(this)
                .clone()
                .each(function () {
                  ...
                  $(this)
                    .find('.semantic-select-wrapper')
                    .each(function () {
                      $(this).find('.text').html('');
                    });
                  $(this)
                    .find('label.checkbox.active')
                    .each(function () {
          ...
          $('*[data-copied="' + $(this).attr('data-copy') + '"]:first')
            .removeClass('copying')
            .removeAttr('data-copied');
          return false;
        });
      },
      miscellaneous: function () {
        ...
        $('.scheme-a.a, .scheme-a.b, #user form, .form-d .submit .drop').append('<div class="fit a"></div>');
        ...
        $('html.f #root').append(
          '<nav id="nav-f"><div class="tabs"><ul></ul><div></div></div></nav><div id="shadow-f"></div>'
        );
        ...
        $('html.f .nav-a:first, html.f .list-h:first, html.f .list-i:first, html.f .scheme-d:first')
          .clone()
          .appendTo('#nav-f .tabs > div');
        $('#user form:first').clone().prependTo('#nav-f');
        $(
          'html.f .nav-a:first :header, html.f #content > footer :header, html.f #content > footer .scheme-d .hidden'
        ).appendTo('#nav-f .tabs > ul');
        $('#nav-f .tabs > ul > *').wrapInner('<li><a></a></li>').children('li').unwrap();
        $('#nav-f form label').each(function () {
          $(this).attr('for', $(this).attr('for') + '2');
        });
        $('#nav-f form input').each(function () {
          $(this)
            .attr('id', $(this).attr('id') + '2')
            .attr('name', $(this).attr('name') + '2');
        });
        ...
        $('html').on('click', function () {
          $('.color-picker.active').removeClass('active');
          $('#user form.toggle, #nav-f form.toggle, .drop-a.toggle, .drop-b.toggle').removeClass('toggle');
        });
        $(
