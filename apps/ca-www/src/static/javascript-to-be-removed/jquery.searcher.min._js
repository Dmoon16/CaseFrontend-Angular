...
(function () {
  ...
  function a(a) {
    ...
    (b.prototype = {
      ...
      _create: function () {
        var b = this.options;
        (this._$element = a(this.element)), (this._fn = a.proxy(this._onValueChange, this));
        var c = 'input.' + d + ' change.' + d + ' keyup.' + d;
        (this._$input = a(b.inputSelector).bind(c, this._fn)), (this._lastValue = '');
      ...
      _onValueChange: function () {
        var b = this.options,
          d = b.textSelector,
          e = b.toggle || f.toggle,
          g = 'gm' + (b.caseSensitive ? '' : 'i'),
          h = new RegExp('(' + c(this._$input.val()) + ')', g);
        h.toString() !== this._lastValue &&
          ((this._lastValue = h.toString()),
          this._$element.find(b.itemSelector).each(function () {
            var b = a(this),
              c = d ? b.find(d) : b,
              f = !1;
            (c = c.each(function () {
              return (f = f || !!a(this).text().match(h)), !f;
            })),
              e(this, f);
          }));
      }
      ...
      (a.fn[d] = function (c) {
        return this.each(function () {
          var d = a.data(this, e);
          d && 'dispose' === c
            ? (d.dispose(), a.removeData(this, e))
            : d
            ? a.extend(d.options, c)
            : 'object' == typeof c && a.data(this, e, new b(this, c));
        });
      });
  }
