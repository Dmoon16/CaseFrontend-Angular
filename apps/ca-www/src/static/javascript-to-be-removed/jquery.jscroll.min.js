    ...
    var d = b.data('jscroll'),
      ...
      o = function (a) {
        ...
        f.pagingSelector
          ...
          : ((b = a.parent().not('.jscroll-inner,.jscroll-added').addClass('jscroll-next-parent').hide()),
      ...
      q = function () {
        ...
        return !c.waiting && l + f.padding >= a.outerHeight()
          ? (u('info', 'jScroll:', a.outerHeight() - l, 'from bottom. Loading next request...'), t())
          : void 0;
      },
      r = function (a) {
        return (
          (a = a || b.data('jscroll')),
          a && a.nextHref ? (s(), !0) : (u('warn', 'jScroll: nextSelector not found - destroying'), p(), !1)
        );
      },
      s = function () {
        var a = b.find(f.nextSelector).first();
        a.length &&
          (f.autoTrigger && (f.autoTriggerUntil === !1 || f.autoTriggerUntil > 0)
            ? (o(a),
              j.height() <= i.height() && q(),
      ...
      t = function () {
        ...
        return (
          ...
          c
            ...
            .last()
            .html('<div class="jscroll-loading">' + f.loadingHtml + '</div>'),
          ...
          if ('object' == typeof a) {
            ...
            for (var c in a)
              'function' == typeof console[c]
                ? ((b = a[c].length ? a[c] : [a[c]]), console[c].apply(console, b))
                : console.log.apply(console, b);
          } else console[a].apply(console, Array.prototype.slice.call(arguments, 1));
      };
    return (
      b.data('jscroll', a.extend({}, d, { initialized: !0, waiting: !1, nextHref: l })),
      n(),
      m(),
      s(),
