  ...
  $.fn.jScrollPane = function (settings) {
    ...
    function JScrollPane(elem, s) {
      ...
      if (elem.css('box-sizing') === 'border-box') {
        ...
        originalPaddingTotalWidth =
          (parseInt(elem.css('paddingLeft'), 10) || 0) + (parseInt(elem.css('paddingRight'), 10) || 0);
      }
          ...
          container.append(
            $('<div class="jspVerticalBar" />').append(
              ...
              $('<div class="jspTrack" />').append(
                $('<div class="jspDrag" />').append($('<div class="jspDragTop" />'), $('<div class="jspDragBottom" />'))
              ),
        ...
        if (isScrollableH) {
          container.append(
            $('<div class="jspHorizontalBar" />').append(
              ...
              $('<div class="jspTrack" />').append(
                $('<div class="jspDrag" />').append($('<div class="jspDragLeft" />'), $('<div class="jspDragRight" />'))
              ),
